...
## <a name="fogus.text/md">`md`</a><a name="fogus.text/md"></a>
``` clojure
...
<p><sub><a href="https://github.com/fogus/thneed/blob/master/src/fogus/text.clj#L20-L65">Source</a></sub></p>

## <a name="fogus.text/org">`org`</a><a name="fogus.text/org"></a>
``` clojure
...
Takes a string ``s`` containing Org-mode-like text and returns a string of the
  ...
  Embedded HTML tags are not supported and the rendering behavior when including
  them in the input text is undefined.
<p><sub><a href="https://github.com/fogus/thneed/blob/master/src/fogus/text.clj#L67-L105">Source</a></sub></p>
...
## <a name="fogus.util/html-escapes">`html-escapes`</a><a name="fogus.util/html-escapes"></a>
